...
<p align="center"> <img src="Resources/VBA_Challenge_2018-refact2.png" width ="30%" alt="VBA_Challenge_2018-refact2"> </p>
...
The refactored code reduced the iterations from aproximately 36,000 to approximately 3,000. The first version of the code took approximately 1 second to go through all the data and the final version took approximately to 0.1 seconds. The refactored code was faster by a factor of 10 without changing the results.  The final version of the refactored code made it so that it will be simple to maintain the code in the future by minimizing evaluations.  
